...
keywords          : "language acquisition, corpus analysis, computational modeling, pragmatics"
wordcount         : "X"
...
apa_table(topic_tab, font_size = "footnotesize",
         caption = "The most distinctive words in each topic. Distinctiveness is measured by the difference between a word's probability in a given topic and its average probability across all topics. Tokens for utterances with all non-words are not included here.")
```
...
```{r branching-out-plot, fig.align = "left", fig.cap = "The proportion of utterances classified as each communicative act type produced by children and parents across development.", fig.width = 6, fig.height =3}
topics <- c("mental states", "labeling", "counting", "evaluation", "proposed actions",
