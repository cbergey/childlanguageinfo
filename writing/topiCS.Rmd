...
```{r topic-table, results="asis", fig.cap = "The most distinctive words in each topic. Distinctiveness is measured by the difference between a word's probability in a given topic and its average probability across all topics."}
...
```{r branching-out-plot, fig.align = "left", fig.cap = "The proportion of utterances classified as each communicative act type produced by children and parents across development."}
topics <- c("mental states", "labeling", "counting", "evaluation", "proposed actions",
...
```{r entropy-plot, out.width="1.05\\linewidth", include=TRUE, fig.align="center", fig.cap = "Entropy of communicative acts and words produced by children and parents over development.", echo = FALSE}
